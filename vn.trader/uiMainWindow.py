...
from ctaAlgo.uiChanlunWidget import ChanlunEngineManager
#from chanlunAlgo.uiChanlunWidget import ChanlunEnginemanager
...
class MainWindow(QtGui.QMainWindow):
    ...
    def initMenu(self):
        ...
        chanlunAction = QtGui.QAction(u'缠论策略', self)
        chanlunAction.triggered.connect(self.openChanlun)
        ...
        algoMenu.addAction(chanlunAction)
